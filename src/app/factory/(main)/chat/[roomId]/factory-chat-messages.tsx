...
interface FactoryChatMessagesProps {
  roomId: string
  currentUserId: string
  initialMessages: Message[]
}

export function FactoryChatMessages({ roomId, currentUserId, initialMessages }: FactoryChatMessagesProps) {
